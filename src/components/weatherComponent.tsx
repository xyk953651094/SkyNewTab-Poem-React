...
function WeatherComponent(props: any) {
    ...
    const popoverContent = (
        <Space direction="vertical">
            <Button type="text" shape="round" icon={<i className="bi bi-moisture">&nbsp;&nbsp;&nbsp;</i>} onMouseOver={btnMouseOver} onMouseOut={btnMouseOut}
                    className={"popoverFont"} style={{color: props.fontColor, cursor: "default"}}>
                {"空气湿度：" + humidity}
            </Button>
            <Button type="text" shape="round" icon={<i className="bi bi-water">&nbsp;&nbsp;&nbsp;</i>} onMouseOver={btnMouseOver} onMouseOut={btnMouseOut}
                    className={"popoverFont"} style={{color: props.fontColor, cursor: "default"}}>
                {"空气质量：" + pm25}
            </Button>
            <Button type="text" shape="round" icon={<i className="bi bi-cloud-rain">&nbsp;&nbsp;&nbsp;</i>} onMouseOver={btnMouseOver} onMouseOut={btnMouseOut}
                    className={"popoverFont"} style={{color: props.fontColor, cursor: "default"}}>
                {"降雨概率：" + rainfall}
            </Button>
            <Button type="text" shape="round" icon={<i className="bi bi-eye">&nbsp;&nbsp;&nbsp;</i>} onMouseOver={btnMouseOver} onMouseOut={btnMouseOut}
                    className={"popoverFont"} style={{color: props.fontColor, cursor: "default"}}>
                {"视线距离：" + visibility}
            </Button>
            <Button type="text" shape="round" icon={<i className="bi bi-wind">&nbsp;&nbsp;&nbsp;</i>} onMouseOver={btnMouseOver} onMouseOut={btnMouseOut}
                    className={"popoverFont"} style={{color: props.fontColor, cursor: "default"}}>
                {"风速情况：" + windInfo}
            </Button>
